<template>
  <div class="mx-[50px] mb-[40px]">
    <swiper
      ...
      :navigation="false"
      :modules="modules"
      class="mt-[80px] rounded-b-[20px] bg-origin-border"
    >
      <swiper-slide v-for="item in sliderImage">
        ...
        >
          ...
          <div class="relative flex flex-col items-center gap-[44px]">
            ...
            <div
              class="flex justify-center items-center mx-[53px] bg-search w-[360px] h-[56px] rounded-[40px] border border-width border-solid outline-0 px-5"
            >
              <div class="flex gap-[12px]">
                <img src="/images/Search.svg" alt="search" />
                <span
                  class="font-medium text-[#d9d9d9b3] text-[16px] select-none cursor-text"
                  >Find your NFT</span
                >
              </div>
            </div>
